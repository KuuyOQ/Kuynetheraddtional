...
public class Kuynethermin extends WorldGenerator
{
    ...
    public Kuynethermin(Block p_i45459_1_, int p_i45459_2_)
    {
        this(p_i45459_1_, p_i45459_2_, Blocks.netherrack);
    }

    public Kuynethermin(Block p_i45460_1_, int p_i45460_2_, Block p_i45460_3_)
    {
    ...
    public Kuynethermin(Block block, int meta, int number, Block target)
    {
